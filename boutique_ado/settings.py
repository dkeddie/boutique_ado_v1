...
ALLOWED_HOSTS = ['dkeddie-boutique-ado.herokuapp.com', 'localhost']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'bag.contexts.bag_contents', #FOR BAG CONTENTS
            ],
            'builtins': [
...
if 'USE_AWS' in os.environ:
    ...
    AWS_S3_CUSTOM_DOMAIN = f'{AWS_STORAGE_BACKET_NAME}.s3.amazonaws.com'
